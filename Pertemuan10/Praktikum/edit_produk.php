...
<head>
  ...
  <title>Edit Produk - Dashboard Administrator</title>
  <style>
    * {
      margin: 0;
      padding: 0;
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          ...
          <select id="kategori" name="kategori" required>
            ...
            <option value="Furniture" <?php echo $produk['kategori'] == 'Furniture' ? 'selected' : ''; ?>>Furniture</option>
            <option value="Buku" <?php echo $produk['kategori'] == 'Buku' ? 'selected' : ''; ?>>Buku</option>
